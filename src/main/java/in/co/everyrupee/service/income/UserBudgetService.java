...
public class UserBudgetService implements IUserBudgetService {
	...
	public UserBudget saveAutoGeneratedUserBudget(MultiValueMap<String, String> formData,
		...
		try {
			...
			logger.debug("Budget for the category is empty " + CollectionUtils.isNotEmpty(categoryBudget)
			...
			userBudgetSaved = createUserBudget(formData, pFinancialPortfolioId, true, date);
