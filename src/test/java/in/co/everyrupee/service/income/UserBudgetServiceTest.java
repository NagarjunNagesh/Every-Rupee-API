...
public class UserBudgetServiceTest {
  ...
  @Autowired private UserBudgetService userBudgetService;
  ...
  public void setUp() {
    ...
    userBudget.setBudgetId(new BigInteger("194062022"));
    ...
    try {
      ...
      // Fetch all budget
      Mockito.when(
              userBudgetRepository.fetchAllUserBudget(FINANCIAL_PORTFOLIO_ID, getDateMeantFor()))
      ...
      Mockito.when(
              userBudgetRepository.fetchAutoGeneratedUserBudgetWithCategoryIds(
                  categoryIdList, FINANCIAL_PORTFOLIO_ID, getDateMeantFor()))
          .thenReturn(getUserBudgetList());
      ...
      Mockito.when(
              userBudgetRepository.fetchUserBudgetWithCategoryIds(
                  categoryIdList, FINANCIAL_PORTFOLIO_ID, getDateMeantFor()))
          .thenReturn(getUserBudgetList());
  ...
  public void userBudgetRetrieveMock() {
    List<UserBudget> found =
        getUserBudgetService().fetchAllUserBudget(FINANCIAL_PORTFOLIO_ID, DATE_MEANT_FOR);
  ...
  public void fetchAutoGeneratedUserBudgetByCategoryIds() {
    ...
    List<UserBudget> found =
        getUserBudgetService()
            .fetchAutoGeneratedUserBudgetByCategoryIds(
                categoryId, FINANCIAL_PORTFOLIO_ID, DATE_MEANT_FOR);
    assertThat(found).isNotEmpty();
  }
  ...
  public void saveAutoGeneratedUserBudgetException() {
    ...
    getUserBudgetService().saveAutoGeneratedUserBudget(formData, FINANCIAL_PORTFOLIO_ID);
  }
  ...
  public void saveUserBudget() {
    ...
    when(getUserBudgetRepository().save(Mockito.any(UserBudget.class)))
        .thenReturn(userBudgetReturned);
  ...
  public void deleteAutoGeneratedUserBudgetsException() {
    ...
    getUserBudgetService()
        .deleteAutoGeneratedUserBudgets(categoryIds, FINANCIAL_PORTFOLIO_ID, DATE_MEANT_FOR);
  }
  ...
  public void updateAutoGeneratedUserBudgets() {
    ...
    getUserBudgetService()
        .updateAutoGeneratedUserBudget(
            FINANCIAL_PORTFOLIO_ID, categoryIdAndCategoryTotalMap, DATE_MEANT_FOR);
    List<Integer> categoryIds = new ArrayList<Integer>();
    categoryIds.add(3);
    verify(getUserBudgetRepository(), times(1))
        .fetchAutoGeneratedUserBudgetWithCategoryIds(
            categoryIds, FINANCIAL_PORTFOLIO_ID, getDateMeantFor());
